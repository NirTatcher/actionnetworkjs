...
const donationsInit = (apiKey)=> {
       const utils = utilsInit(apiKey)
        return {
            ...
            get: async function (page = null, per_page = null, limit = null, filter = null) { return page ? await utils.getResourceCollectionPaginated(`donations`, page, per_page, filter) : await utils.getResourceCollection(`donations`, limit, per_page, filter) },
